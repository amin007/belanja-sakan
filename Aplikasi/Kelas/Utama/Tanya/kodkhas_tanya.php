...
class Kodkhas_Tanya extends \Aplikasi\Kitab\Tanya
{
#===========================================================================================
#------------------------------------------------------------------------------------------#
...
#------------------------------------------------------------------------------------------#
	public function cariKhas01($medan1,$a=null,$b=null)
	{
		...
		$medanB['jadual'][0]['kod'] = $a;
		$medanB['jadual'][0]['keterangan'] = $a;
		$medanB['medan'][0]['kod'] = $b;
		$medanB['medan'][0]['keterangan'] = $b;
		$medanA = array_merge($medan1, $medanB);
...
#------------------------------------------------------------------------------------------#
	public function susunPembolehubah($p)
	{
		//echo '<hr>Nama class Tanya:' . __METHOD__ . '()<hr>';
		//$this->semakPembolehubah($p,'papa');
		$a = $p[0];
...
#------------------------------------------------------------------------------------------#
	...
	{
		//echo '<hr>Nama class Tanya x:' . __METHOD__ . '()<hr>';
		//list($idUser,$namaPendek) = $this->tanyaDataSesi();
		//$this->semakPembolehubah($p,'papa');
		list($jadual,$b,$c) = $p;
		...
		# semak database
			$carian[] = array('fix'=>'x=', # cari x= / %like% / xlike
				'atau'=>'WHERE', # WHERE / OR / AND
				'medan' => 'medan', # cari dalam medan apa
				'apa' => $c); # benda yang dicari//*/
