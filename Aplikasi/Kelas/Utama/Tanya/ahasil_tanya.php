...
#------------------------------------------------------------------------------------------#
	...
	#***************************************************************************************
		...
		$p[$k][]=array($a=>'05', $b=>'[D] JUMLAH PINDAHAN SEMASA YANG DITERIMA [INCS{(41)+'
			. ' (42)+ ... +(46)}]|05');
		$p[$k][]=array($a=>'06', $b=>'[E] JUMLAH PINDAHAN SEMASA BERSIH YANG DITERIMA'
	...
	#***************************************************************************************
		...
		$p[$k][]=array($a=>'C1', $b=>'1.Pendapatan bersih tahunan Sama ada [A1 - A2]'
				. '  atau [B1 atau B2] | C1');
		$p[$k][]=array($a=>'C2', $b=>'2.Peratus pembahagian yang dipegang oleh'
				. '  ahli-ahli isi rumah | C2');
		$p[$k][]=array($a=>'C3', $b=>'3.Nilai Mutlak bagi C2 | C3');
		$p[$k][]=array($a=>'C4A', $b=>'4.Jumlah nilai bagi keluaran sendiri yang'
				. ' digunakan untuk : (a) Kegunaan sendiri | c4a');
		$p[$k][]=array($a=>'C4B', $b=>'4.Jumlah nilai bagi keluaran sendiri yang'
				. ' digunakan untuk : (b) Lain-lain (seperti zakat, biji benih,'
				. ' pemberian, dll.)|c4b');
		$p[$k][]=array($a=>'C4', $b=>'4.Jumlah nilai bagi keluaran sendiri yang'
				. ' digunakan : C4 = (a) + (b) |C4');
		$p[$k][]=array($a=>'C5', $b=>'5.Pendapatan bersih yang diterima oleh'
	...
	#***************************************************************************************
		...
		$p[$k][]=array($a=>'C2', $b=>'2.Peratus pembahagian yang dipegang oleh'
				. ' ahli isi rumah|C2');
		$p[$k][]=array($a=>'C3', $b=>'3.Nilai Mutlak bagi C2 | C3');
		$p[$k][]=array($a=>'C4', $b=>'4.Anggaran barangan keluaran yang digunakan'
				. ' sendiri setahun|C4');
		$p[$k][]=array($a=>'C5', $b=>'5.Pendapatan bersih yang diterima oleh'
				. ' ahli isi rumah[C5 = C3 + C4]|C5')
		//=>array( $a=>'-', $b=>'*');
