...
class Kodkhas extends \Aplikasi\Kitab\Kawal
{
#===========================================================================================
...
#-------------------------------------------------------------------------------------------
	...
	{
		//echo '<hr>Nama class :' . __METHOD__ . '()<hr>';
		//$this->semakPembolehubah($p1,'papa');
...
#-------------------------------------------------------------------------------------------
	...
	{
		//echo '<hr>Nama class entah:' . __METHOD__ . '()<hr>';
		//$this->semakPembolehubah($p1,'papa');
		$p2 = $p1[2];//echo "<hr>\$p2=$p2<hr>";
		# Set pembolehubah utama
...
#-------------------------------------------------------------------------------------------
	public function baru($a,$b)
	{
		//echo '<hr> Nama class : ' . __METHOD__ . '<hr>';
		# Set pembolehubah utama
		$namaFungsi =  $this->_folder . '/' . __FUNCTION__ . '';
		$p = array($a,$b,$c=0);//$this->semakPembolehubah($p,'papa');
		# Set fungsi2 berkaitan
		$this->panggilKhas02(array('kod_borang',$a,$b));
		$this->papar->bentukJadual01 = $this->tanya->
			cariKhas01($this->papar->bentukJadual02,$a,$b);
		unset($this->papar->bentukJadual02);//*/
		# untuk bentuk borang
		$this->panggilBorang01(array('kod_borang',$a,$b));
		$this->papar->carian[] = "$namaFungsi/$a/$b";
...
#-------------------------------------------------------------------------------------------
	public function baruSimpan($a,$b,$c,$d)
	{
		//echo '<hr>Nama class :' . __METHOD__ . '()<hr>';
		$senaraiJadual = array('kod_borang');
		# ubahsuai $posmen
		...
		# pergi papar kandungan
		//echo 'location:' . URL . "$a/$b/$c/$d";
		header('location:' . URL . "$a/$b/$c/$d"); //*/
	}
#-------------------------------------------------------------------------------------------
	function ubahsuaiPostBaru($senaraiJadual)
	{
		...
		if ( in_array($myTable,$senaraiJadual) ):
			...
			{
				if($kekunci=='keterangan'):
					$posmen[$myTable][$kekunci] = huruf('Besar_Depan', bersih($papar));
				else:
